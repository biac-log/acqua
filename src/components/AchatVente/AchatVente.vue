...
import { PeriodeComptable, Journal, EntetePieceComptable } from "@/models/AchatVenteModels";
...
this.journalSearched= this.journalSelected;
  ...
  public OpenPieceComptable(entete: EntetePieceComptable) {
    ...
    (this.$refs.refPiece as AchatVentePiece).Init(entete, this.periodeSearched, this.journalSearched);
  }
